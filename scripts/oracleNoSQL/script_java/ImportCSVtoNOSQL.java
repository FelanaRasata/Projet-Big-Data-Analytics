...
public class ImportCSVtoNOSQL {
    ...
    public static void main(String[] args) {
        ...
        String statementM = importer.getStatementString(marketing);
        importer.createTable(statementM);

        String statementC = importer.getStatementString(clients);
        importer.createTable(statementC);

        importer.insertRow(marketing, MARKETING_FILE_PATH, importer.store);
        importer.insertRow(clients, CLIENT_FILE_PATH, importer.store);
    ...
    public void createTable(String statement) {
        ...
        System.out.println("****** Dans : createMarketing********");
        try {
            /*
             * Adda table to the database.
            ...
            while ((line = br.readLine())!= null) {
                ...
                for (int i = 0; i <nblisteAttributs; i++) {
                    ...
                    try {
                        ...
                        System.err.println("Erreur de conversion pour l'attribut " + listeAttributs.get(i) + ": " + e.getMessage());
                    }
                }
...
class Clients {
    ...
    public Clients(int age, String sexe, int taux, String situationFamiliale, int nbEnfantsAcharge, boolean deuxiemevoiture, String immatriculation) {
        this.age = age;
        this.sexe = sexe;
        this.taux = taux;
        this.situationFamiliale = situationFamiliale;
